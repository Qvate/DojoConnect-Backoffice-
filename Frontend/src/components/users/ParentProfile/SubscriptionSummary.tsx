      ...
      <div className="bg-white rounded-md shadow p-6">
        <div className="flex justify-between items-start gap-6">
          <div>
            ...
            <div className="text-black-300 text-lg font-bold">Basic Plan</div>
          </div>
          <div>
            <div className="text-gray-500 text-xs">Billing Cycle</div>
            <div className="text-black-300 text-lg font-bold">Monthly</div>
          </div>
          <div>
            <div className="text-gray-500 text-xs">Plan Cost</div>
            <div className="text-black-300 text-lg font-bold">$27.00</div>
          </div>
        </div>
        <div className="mt-6">
        ...
        <div className="mt-4 text-gray-700 text-sm">
          Next Payment is <span className="font-semibold">$27.00</span>, to be charged on <span className="font-semibold">March 24, 2025</span>
        </div>
        <div className="relative mt-6 w-[405px] h-[19px] flex space-x-4">
          ...
          <svg xmlns="http://www.w3.org/2000/svg" className="absolute top-0 left-0" width="361" height="19" fill="none">
